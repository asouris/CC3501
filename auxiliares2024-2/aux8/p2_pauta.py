...
from utils.drawables import Texture, Model, SpotLight, PointLight, DirectionalLight, Material
...
if __name__ == "__main__":
    ...
    basic_pipeline = init_pipeline(root + "/p1_pauta/basic.vert", root + "/p1_pauta/basic.frag")
    light_pipeline = init_pipeline(root + "/p1_pauta/textured_mesh_lit.vert", root + "/p1_pauta/textured_mesh_lit.frag")
    clight_pipeline = init_pipeline(root + "/p1_pauta/color_mesh_lit.vert", root + "/p1_pauta/color_mesh_lit.frag")
