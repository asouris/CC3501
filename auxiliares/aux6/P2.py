...
# Esta función deberá entregar las coordenadas uv para un cuadrado
# es decir 2 valores por vertice = 8 valores
...
void main() {
    ...
    tierra = [
        *get_atlas_uv(27, 20, atlas), #lados
        *get_atlas_uv(27, 20, atlas),
        *get_atlas_uv(27, 20, atlas),
        *get_atlas_uv(27, 20, atlas),
        *get_atlas_uv(8, 14, atlas),  #arriba
        *get_atlas_uv(23, 23, atlas), #abajo
    ]
