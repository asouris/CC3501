...
if __name__ == "__main__":
    ...
    def on_draw():
        ...
        transform = tr.identity()
        #A
        # transform = transform @ tr.translate(-0.6, 0 ,0)
        ...
        #C 
        transform = transform @ tr.translate(-0.6,-0.1,0)
        transform = transform @ tr.translate(0, 0 ,0)
        transform = transform @ tr.uniformScale(0.5)
        transform = transform @ tr.rotationZ(np.radians(-90)) # probar cambiar esta linea al inicio
