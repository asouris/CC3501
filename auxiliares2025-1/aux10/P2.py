...
if __name__ == "__main__":
    ...
    for c in chunks:
        for i in range(1000):
            ...
            manager.add_collider(colliders.AABB(f"{c.id}({x},{y},{z})", [0, 0, 0], [1, 1, 1]))
