...
if __name__ == "__main__":
    ...
    controller = Controller(800, 600, "Auxiliar Colisiones - P1")
    controller.set_exclusive_mouse(True)

    # Label personalizado para mostrar los FPS en la esquina superior derecha (Blanco)
    ...
    # Generación de la grilla plana (con bloques de aire aleatorios)
    for c in chunks:
        for z in range(MyChunk.COUNT):
            for x in range(MyChunk.COUNT):
